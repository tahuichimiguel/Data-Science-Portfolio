...
path <-'/Users/Mikey/Documents/Case-Studies/Glass'
filename<-'glass.csv'
setwd(path)
DT<-fread(filename)
```
...
ggplot(data=DF.lda.feat, aes(x=LD1,fill=as.factor(DF.lda.feat[,ncol(DF.lda.feat)])))+geom_density(alpha=0.25) 
ggplot(data=DF.lda.feat, aes(x=LD2,fill=as.factor(DF.lda.feat[,ncol(DF.lda.feat)])))+geom_density(alpha=0.25) 
ggplot(data=DF.lda.feat, aes(x=LD3,fill=as.factor(DF.lda.feat[,ncol(DF.lda.feat)])))+geom_density(alpha=0.25) 
