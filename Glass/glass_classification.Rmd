...
set.seed(123)
gbm.fit.brute1<- train(Type~., data=DT.brute, trControl=train_controlA, method="gbm",verbose=FALSE)
gbm.fit.brute1
...
print('Observations with Zero Potassium, Iron, and Barium')
...
print('Glass Type Distribution in Cleaned Data')
DT.clean[,.N,by=Type]
```
...
* F2
    + Type 7 Feature: Ba 25% Quantile, is higher that all other class maxima [Higher Ba ~ Higher Prob(Type 7)] 
...
* F7
    + Type 5 & 7 Feature: PC1 Separates 5 & 7 from rest
* F8
    + Type 5 & 7 Feature :LD1 may be able to be used to identity groups 5 & 7 
...
* F9
    ...
    + Use Simulations to Determine Threshold with Non-Parametric Bootstrap Simulations
```{r }
